...
namespace std {
    ...
    struct numeric_limits <double_integer <LO, HI> > {
        ...
        static double_integer <LO, HI> min() throw() {
            return double_integer <LO, HI> (std::numeric_limits <LO> ::min (),
                                            std::numeric_limits <HI> ::min ());
        };
        
        static double_integer <LO, HI> max() throw() {
            return double_integer <LO, HI> (std::numeric_limits <LO> ::max (),
                                            std::numeric_limits <HI> ::max ());
        };
        
        static const int digits = std::numeric_limits <HI> ::digits
                                + std::numeric_limits <LO> ::digits;
        static const int digits10 = digits * 643 / 2136;
        
        static const bool is_signed = std::numeric_limits <HI> ::is_signed;
        static const bool is_integer = true;
        static const bool is_exact = true;
        static const int radix = 2;
        static double_integer <LO, HI> epsilon() throw()
            { return double_integer <LO, HI> (); }
        static double_integer <LO, HI> round_error() throw()
            { return double_integer <LO, HI> (); }
        ...
        static double_integer <LO, HI> infinity() throw()
            { return double_integer <LO, HI> (); }
        static double_integer <LO, HI> quiet_NaN() throw()
            { return double_integer <LO, HI> (); }
        static double_integer <LO, HI> signaling_NaN() throw()
            { return double_integer <LO, HI> (); }
        static double_integer <LO, HI> denorm_min() throw()
            { return double_integer <LO, HI> (); }
        ...
        static const bool traps = std::numeric_limits <HI> ::traps;
